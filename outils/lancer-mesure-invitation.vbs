...
' Puis, depot ouvert:
'
' ESPACER L'ACCEPTATION DU GROUPE ET CELLE DU SONGE, ET NOTER L'HEURE DE
' CHACUNE. `ikg` et `ixo` sont deux requetes sortantes a UN SEUL VARINT: leur
' empreinte est identique, et l'appariement ne les separera jamais. Seule la
' chronologie le fera. Constate le 08/09 au soir, sur cette mesure meme.
'
